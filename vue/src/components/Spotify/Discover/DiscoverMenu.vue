<template>
  <div class="flex flex-column mx-1">
    <Card class="m-1 cursor-pointer" v-for="(menuItem, index) in libarayMenuItems" :key="index"
...
// data selected
const libarayMenuItems: Ref<{ label: string, description: string; icon: string; to: string }[]>
  = ref([
    {
      label: "Playlists",
    ...
    {
      label: "Albums",
      description: "Save your favorite albums",
